  ...
  return (
    <div className="container h-screen relative py-8 px-4 mx-auto">
      <div className="flex gap-8">
        <div className="relative basis-4/12 overflow-auto h-[calc(100vh-8rem)] px-2">
        ...
        <div className="basis-8/12 rounded flex flex-col gap-6">
          <div className="flex flex-col">
            <h1 className="text-sm font-bold px-3 py-4">SET UP</h1>
          ...
          <div className="flex flex-col">
            <h1 className="text-sm font-bold px-3 py-4">VIEW</h1>
            <div className="flex flex-wrap -mr-5">
              {[...Array(1)].map((_, index) => (
                <div
                  key={index}
          ...
          <div className="flex flex-col">
            <h1 className="text-sm font-bold px-3 py-4">DRONE</h1>
            <div className="flex flex-wrap -mr-5">
              {[...Array(0)].map((_, index) => (
                <div
                  key={index}
          ...
          <div className="flex flex-col">
            <h1 className="text-sm font-bold px-3 py-4">ANIMATION</h1>
            <div className="flex flex-wrap -mr-5">
              {[...Array(0)].map((_, index) => (
                <div
                  key={index}
